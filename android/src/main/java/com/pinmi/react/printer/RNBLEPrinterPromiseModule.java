...
import com.pinmi.react.printer.adapter.BLEPrinterPromiseAdapter;
...
public class RNBLEPrinterPromiseModule extends ReactContextBaseJavaModule implements RNPrinterPromiseModule {

    protected ReactApplicationContext reactContext;

    protected PrinterPromiseAdapter adapter;

    public RNBLEPrinterPromiseModule(ReactApplicationContext reactContext) {
        super(reactContext);
    ...
    public void init(Promise promise) {
        this.adapter = BLEPrinterPromiseAdapter.getInstance();
